...
function TableRow1(props) {
    return (
        <tr class="bg-white border-black border-b">
            ...
            <table className='flex height52'>
                <th scope="col" class="text-xs text-gray-900 height52 flex w-1/2 height65  border-black">
                    ...
                    <tr className='w-1/3 h-full border-r p-2 border-black height65'><span className='align-middle tc'>_</span></tr>
                    <tr className='w-1/3 h-full border-r p-2 border-black height65'><span className='align-middle tc'>_</span></tr>
                    <tr className='w-1/3 h-full p-2 border-black border-r height65'><span className='align-middle tc'>_</span></tr>
                    {/* </tr> */}
                </th>
                <th scope="col" class="text-xs text-gray-900 height52 flex w-1/2 height65  border-black">
                    {/* <tr class="text-xs text-gray-900  w-full border-b border-r p-2  border-black">Amount</tr> */}
